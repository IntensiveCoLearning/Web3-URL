...
- **共学报名**：
  ...
  - 复制 Template_WICL1st.md （这个非常重要！）创建你的个人学习笔记，按照文档内提示要求填写你的报名信息，并且重命名为你的名字：YourName_WICL1st.md。

  - 创建一个 PR 到当前仓库，本残酷共学助教会对你的 PR 进行 review，review 通过后，你的 PR 会被 merge 到 main 分支。「**Web3 URL 残酷共学记录表**」之后会自动登记你的名字。
